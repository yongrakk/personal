      ...
      <div id="comments">
        ...
        <form action="join" method="post" id="joinform">
      	<table>
      		<tr>
      			<td>ID</td>
      			<td><input type="text" id="userid" name="userid" autocomplete="off"/></td>
      		</tr>
      		<tr>
      			<td>Password</td>
      			<td><input type="password" id="userpwd1" name="userpwd" autocomplete="off"/></td>
      		</tr>
      		<tr>
      			<td>Password</td>
      			<td><input type="password" id="userpwd2" autocomplete="off"/></td>
      		</tr>
      		<tr>
      			<td>Name</td>
      		...
      		<tr>
      			<td>Email</td>
      			<td><input type="email" id="useremail" name="useremail" autocomplete="off"/></td>
      		</tr>
      		<tr>
